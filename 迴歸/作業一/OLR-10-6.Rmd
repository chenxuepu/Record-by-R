...
while(!exists("f_1_fit")){
  ...
  tryCatch(
    {
      f_1_fit <- stats4::mle(f_1_test,start = start,nobs = nrow(data))
    }
    ,warning = function(war)
        {
...
start <- list(beta_1=1,beta_2=1,beta_3=1,beta_4=1,beta_5=1,beta_6=1,beta_7=1,beta_8=1,beta_9=1,beta_10=1,beta_11=1,beta_12=1,beta_13=1,beta_14=1,t_1=1,t_2=1,t_3=1,t_4=1,t_5=1,t_6=1,t_7=1,t_8=1,constant=1)
