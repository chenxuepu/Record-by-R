...
```{r}
w <- weight_by_index(iris_index,0.9,iris[-index,1:4],label)
set.seed(610811101)
...
```{r}
w <- weight_by_index(iris_index,0.8,iris[-index,1:4],label)
set.seed(610811101)
iris_tsne_2 <- cbind(iris[-index,-5],label) %>% 
  wtsne(check_duplicates = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(iris_index,0.75,iris[-index,1:4],label)
set.seed(610811101)
iris_tsne_2 <- cbind(iris[-index,-5],label) %>% 
  wtsne(check_duplicates = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(iris_index,0.6,iris[-index,1:4],label)
set.seed(610811101)
iris_tsne_2 <- cbind(iris[-index,-5],label) %>% 
  wtsne(check_duplicates = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(fashion_mnist_index,0.9,fashion_mnist[-index,1:784],label)
set.seed(610811101)
...
```{r}
w <- weight_by_index(fashion_mnist_index,0.8,fashion_mnist[-index,1:784],label)
set.seed(610811101)
fashion_mnist_tsne_2 <- cbind(fashion_mnist[-index,1:784],label) %>% 
  wtsne(check_duplicates = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(fashion_mnist_index,0.75,fashion_mnist[-index,1:784],label)
set.seed(610811101)
fashion_mnist_tsne_2 <- cbind(fashion_mnist[-index,1:784],label) %>% 
  wtsne(check_duplicates = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(fashion_mnist_index,0.6,fashion_mnist[-index,1:784],label)
set.seed(610811101)
fashion_mnist_tsne_2 <- cbind(fashion_mnist[-index,1:784],label) %>% 
  wtsne(check_duplicates = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(swiss_roll_index,0.9,swiss_roll[-index,1:3],label)
set.seed(610811101)
...
```{r}
w <- weight_by_index(swiss_roll_index,0.8,swiss_roll[-index,1:3],label)
set.seed(610811101)
swiss_roll_tsne_2 <- cbind(swiss_roll[-index,1:3],label) %>% 
  wtsne(check_duplicates = F,pca = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(swiss_roll_index,0.75,swiss_roll[-index,1:3],label)
set.seed(610811101)
swiss_roll_tsne_2 <- cbind(swiss_roll[-index,1:3],label) %>% 
  wtsne(check_duplicates = F,pca = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(swiss_roll_index,0.6,swiss_roll[-index,1:3],label)
set.seed(610811101)
swiss_roll_tsne_2 <- cbind(swiss_roll[-index,1:3],label) %>% 
  wtsne(check_duplicates = F,pca = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(spirals_index,0.9,spirals[-index,1:2],label)
set.seed(610811101)
...
```{r}
w <- weight_by_index(spirals_index,0.8,spirals[-index,1:2],label)
set.seed(610811101)
spirals_tsne_2 <- cbind(spirals[-index,1:2],label) %>% 
  wtsne(check_duplicates = F,pca = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(spirals_index,0.75,spirals[-index,1:2],label)
set.seed(610811101)
spirals_tsne_2 <- cbind(spirals[-index,1:2],label) %>% 
  wtsne(check_duplicates = F,pca = F,col_weights = w) %$% 
  Y %>% 
...
```{r}
w <- weight_by_index(spirals_index,0.6,spirals[-index,1:2],label)
set.seed(610811101)
spirals_tsne_2 <- cbind(spirals[-index,1:2],label) %>% 
  wtsne(check_duplicates = F,pca = F,col_weights = w) %$% 
  Y %>% 
