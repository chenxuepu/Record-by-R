...
is_RStudio <- ifelse(package_Description_MDS_Euclidean$Topics == "base","base",ifelse(grepl("RStudio",package_Description_MDS_Euclidean$Author),ifelse(package_Description_MDS_Euclidean$Package %in% Rstudio_pg,"best","RStudio"),"others"))
...
is_RStudio <- ifelse(package_Description_tsne$Topics == "base","base",ifelse(grepl("RStudio",package_Description_tsne$Author),ifelse(package_Description_tsne$Package %in% Rstudio_pg,"best","RStudio"),"others"))
...
is_RStudio <- ifelse(package_Description_umap$Topics == "base","base",ifelse(grepl("RStudio",package_Description_umap$Author),ifelse(package_Description_umap$Package %in% Rstudio_pg,"best","RStudio"),"others"))
